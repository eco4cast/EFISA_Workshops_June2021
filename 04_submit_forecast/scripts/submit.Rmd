...
* The `neon4cast` package has two helper functions to generate metdata in the correct format:
    * Step 1: `create_model_metadata()` Creates a yaml file that has the same name as your forecast file. Manually enter your forecast details 
    * Step 2: `write_model_metadata()` Converts the yaml to an eml (xml) file for submission
...
# Resources
* [NEON EFI Challenge Overview](https://projects.ecoforecast.org/neon4cast-docs/) for rules and description
* The [eco4cast::neon4cast package](https://github.com/eco4cast/neon4cast) provides helper functions for many steps throughout the forecasting process. This is still under development, so we welcome feedback from the community.
* [Ecological Forecasting Output and Metadata Standards](https://docs.google.com/document/d/1Xxyt-1LFHCE-CBwF_qad2sWHMHJoZVJdrOyK4ydjeR0/edit)
* [The Challenge dashboard Rshiny app](https://shiny.ecoforecast.org/)  visualizes submissions
